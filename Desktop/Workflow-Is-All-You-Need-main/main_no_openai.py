"""
工作流框架主应用 - 跳过OpenAI初始化版本
Workflow Framework Main Application - Skip OpenAI Version
"""
...
async def startup_event():
    """应用启动事件"""
    try:
        logger.info("正在启动工作流管理框架（无OpenAI版本）...")
        ...
        # 跳过执行引擎和Agent服务启动
        logger.info("跳过执行引擎和Agent服务（无OpenAI版本）")

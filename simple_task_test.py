"""
Simple test for TaskInstanceCreate validation fix
"""
...
def main():
    ...
    try:
        ...
        print("✓ Empty string task_description validation passed")
    except Exception as e:
        print(f"✗ Empty string task_description validation failed: {e}")
    ...
    try:
        ...
        print(f"✓ Default task_description validation passed: '{task_data.task_description}'")
    except Exception as e:
        print(f"✗ Default task_description validation failed: {e}")
    ...
    try:
        ...
        print(f"✓ Normal task_description validation passed: '{task_data.task_description}'")
    except Exception as e:
        print(f"✗ Normal task_description validation failed: {e}")

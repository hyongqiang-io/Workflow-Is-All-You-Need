...
WEATHER_APIS = {
    "openweather": {
        ...
        "api_key": "YOUR_OPENWEATHER_API_KEY_HERE",  # 需要有效的OpenWeather API Key
        "param_name": "appid"
    },
    "weatherapi": {
...
if __name__ == "__main__":
    ...
    print("服务地址: http://0.0.0.0:8085 (外部访问: http://106.54.12.39:8085)")
    print("可用工具:")
    ...
    print("\n🌐 外部访问测试:")
    print("   - 健康检查: curl http://106.54.12.39:8085/health")
    print("   - 获取工具列表: curl http://106.54.12.39:8085/tools")
    print("   - 测试天气查询: curl -X POST http://106.54.12.39:8085/call \\")
    print('     -H "Content-Type: application/json" \\')
    print('     -d \'{"name": "get_current_weather", "arguments": {"city": "London"}}\'')
